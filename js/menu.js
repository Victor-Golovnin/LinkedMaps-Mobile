...
$(".locationImage").on("click", function() {
	...
	selectGeoByClick(function(latlng, revGeocodingResponse) {
		...
		var subcommand = (self.attr("id") == "addrInputA") ? "1" : "2";
		globalStampCounter++;
		setAdv(subcommand, latlng.lat, latlng.lng, globalStampCounter.toString());
...
$("#buildGear").on("click", function() {
	    globalStampCounter++;
		setAdv("3", "0.0", "0.0", globalStampCounter.toString());
});